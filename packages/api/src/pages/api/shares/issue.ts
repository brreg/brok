...
// 				try {
// 					const stealthKeys = await registry.stealthKeys(
...
// 						throw new ApiError(
// 							400,
// 							`addressToReceiveTokens ${addressToReceiveTokens} is not registered in the ERC5564Registry__factory, try registering the stealth keys by using /api/shareholder/register`,
// 						);
// 					}
