...
interface IERC20HoldableToken is IERC20 {
    ...
    event ExecutedHold(bytes32 indexed holdId, bytes32 lockPreimage, address recipient);
     ...
     */
    function executeHold(bytes32 holdId, bytes32 lockPreimage, address recipient) external;
