...
pub mod blocklist_admin_role {
    #[rustfmt::skip]
    const __ABI: &str = "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\",\"components\":[],\"indexed\":true},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\",\"components\":[],\"indexed\":true}],\"type\":\"event\",\"name\":\"BlocklistAdminAdded\",\"outputs\":[],\"anonymous\":false},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\",\"components\":[],\"indexed\":true},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\",\"components\":[],\"indexed\":true}],\"type\":\"event\",\"name\":\"BlocklistAdminRemoved\",\"outputs\":[],\"anonymous\":false},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\",\"components\":[]},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"nonpayable\",\"type\":\"function\",\"name\":\"addBlocklistAdmin\",\"outputs\":[]},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\",\"components\":[]},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"view\",\"type\":\"function\",\"name\":\"isBlocklistAdmin\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\",\"components\":[]}]},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\",\"components\":[]},{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"nonpayable\",\"type\":\"function\",\"name\":\"removeBlocklistAdmin\",\"outputs\":[]},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"nonpayable\",\"type\":\"function\",\"name\":\"renounceBlocklistAdmin\",\"outputs\":[]}]";
    ///The parsed JSON ABI of the contract.
    pub static BLOCKLISTADMINROLE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct BlocklistAdminRole<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for BlocklistAdminRole<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for BlocklistAdminRole<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for BlocklistAdminRole<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for BlocklistAdminRole<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(BlocklistAdminRole)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> BlocklistAdminRole<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            BlocklistAdminRoleEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for BlocklistAdminRole<M> {
    ...
    pub enum BlocklistAdminRoleEvents {
        BlocklistAdminAddedFilter(BlocklistAdminAddedFilter),
        BlocklistAdminRemovedFilter(BlocklistAdminRemovedFilter),
    }
    impl ::ethers::contract::EthLogDecode for BlocklistAdminRoleEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = BlocklistAdminAddedFilter::decode_log(log) {
                return Ok(BlocklistAdminRoleEvents::BlocklistAdminAddedFilter(decoded));
            }
            if let Ok(decoded) = BlocklistAdminRemovedFilter::decode_log(log) {
                return Ok(
                    BlocklistAdminRoleEvents::BlocklistAdminRemovedFilter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for BlocklistAdminRoleEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BlocklistAdminAddedFilter> for BlocklistAdminRoleEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum BlocklistAdminRoleCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for BlocklistAdminRoleCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for BlocklistAdminRoleCalls {
    ...
    impl ::core::fmt::Display for BlocklistAdminRoleCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddBlocklistAdminCall> for BlocklistAdminRoleCalls {
        fn from(value: AddBlocklistAdminCall) -> Self {
            Self::AddBlocklistAdmin(value)
        }
    }
    impl ::core::convert::From<IsBlocklistAdminCall> for BlocklistAdminRoleCalls {
        fn from(value: IsBlocklistAdminCall) -> Self {
            Self::IsBlocklistAdmin(value)
        }
    }
    impl ::core::convert::From<RemoveBlocklistAdminCall> for BlocklistAdminRoleCalls {
        fn from(value: RemoveBlocklistAdminCall) -> Self {
            Self::RemoveBlocklistAdmin(value)
        }
    }
    impl ::core::convert::From<RenounceBlocklistAdminCall> for BlocklistAdminRoleCalls {
