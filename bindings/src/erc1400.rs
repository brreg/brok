...
pub mod erc1400 {
    ...
    pub static ERC1400_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC1400_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC1400<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ERC1400<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ERC1400<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ERC1400<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ERC1400<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC1400)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ERC1400<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ERC1400Events> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC1400Events {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(ERC1400Events::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = ApprovalByPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::ApprovalByPartitionFilter(decoded));
            }
            if let Ok(decoded) = AuthorizedOperatorFilter::decode_log(log) {
                return Ok(ERC1400Events::AuthorizedOperatorFilter(decoded));
            }
            if let Ok(decoded) = AuthorizedOperatorByPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::AuthorizedOperatorByPartitionFilter(decoded));
            }
            if let Ok(decoded) = ChangedPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::ChangedPartitionFilter(decoded));
            }
            if let Ok(decoded) = DocumentRemovedFilter::decode_log(log) {
                return Ok(ERC1400Events::DocumentRemovedFilter(decoded));
            }
            if let Ok(decoded) = DocumentUpdatedFilter::decode_log(log) {
                return Ok(ERC1400Events::DocumentUpdatedFilter(decoded));
            }
            if let Ok(decoded) = IssuedFilter::decode_log(log) {
                return Ok(ERC1400Events::IssuedFilter(decoded));
            }
            if let Ok(decoded) = IssuedByPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::IssuedByPartitionFilter(decoded));
            }
            if let Ok(decoded) = MinterAddedFilter::decode_log(log) {
                return Ok(ERC1400Events::MinterAddedFilter(decoded));
            }
            if let Ok(decoded) = MinterRemovedFilter::decode_log(log) {
                return Ok(ERC1400Events::MinterRemovedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(ERC1400Events::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = RedeemedFilter::decode_log(log) {
                return Ok(ERC1400Events::RedeemedFilter(decoded));
            }
            if let Ok(decoded) = RedeemedByPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::RedeemedByPartitionFilter(decoded));
            }
            if let Ok(decoded) = RevokedOperatorFilter::decode_log(log) {
                return Ok(ERC1400Events::RevokedOperatorFilter(decoded));
            }
            if let Ok(decoded) = RevokedOperatorByPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::RevokedOperatorByPartitionFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(ERC1400Events::TransferFilter(decoded));
            }
            if let Ok(decoded) = TransferByPartitionFilter::decode_log(log) {
                return Ok(ERC1400Events::TransferByPartitionFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for ERC1400Events {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for ERC1400Events {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalByPartitionFilter> for ERC1400Events {
        fn from(value: ApprovalByPartitionFilter) -> Self {
            Self::ApprovalByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<AuthorizedOperatorFilter> for ERC1400Events {
        fn from(value: AuthorizedOperatorFilter) -> Self {
            Self::AuthorizedOperatorFilter(value)
        }
    }
    impl ::core::convert::From<AuthorizedOperatorByPartitionFilter> for ERC1400Events {
        fn from(value: AuthorizedOperatorByPartitionFilter) -> Self {
            Self::AuthorizedOperatorByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<ChangedPartitionFilter> for ERC1400Events {
        fn from(value: ChangedPartitionFilter) -> Self {
            Self::ChangedPartitionFilter(value)
        }
    }
    impl ::core::convert::From<DocumentRemovedFilter> for ERC1400Events {
        fn from(value: DocumentRemovedFilter) -> Self {
            Self::DocumentRemovedFilter(value)
        }
    }
    impl ::core::convert::From<DocumentUpdatedFilter> for ERC1400Events {
        fn from(value: DocumentUpdatedFilter) -> Self {
            Self::DocumentUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<IssuedFilter> for ERC1400Events {
        fn from(value: IssuedFilter) -> Self {
            Self::IssuedFilter(value)
        }
    }
    impl ::core::convert::From<IssuedByPartitionFilter> for ERC1400Events {
        fn from(value: IssuedByPartitionFilter) -> Self {
            Self::IssuedByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<MinterAddedFilter> for ERC1400Events {
        fn from(value: MinterAddedFilter) -> Self {
            Self::MinterAddedFilter(value)
        }
    }
    impl ::core::convert::From<MinterRemovedFilter> for ERC1400Events {
        fn from(value: MinterRemovedFilter) -> Self {
            Self::MinterRemovedFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for ERC1400Events {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<RedeemedFilter> for ERC1400Events {
        fn from(value: RedeemedFilter) -> Self {
            Self::RedeemedFilter(value)
        }
    }
    impl ::core::convert::From<RedeemedByPartitionFilter> for ERC1400Events {
        fn from(value: RedeemedByPartitionFilter) -> Self {
            Self::RedeemedByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<RevokedOperatorFilter> for ERC1400Events {
        fn from(value: RevokedOperatorFilter) -> Self {
            Self::RevokedOperatorFilter(value)
        }
    }
    impl ::core::convert::From<RevokedOperatorByPartitionFilter> for ERC1400Events {
        fn from(value: RevokedOperatorByPartitionFilter) -> Self {
            Self::RevokedOperatorByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for ERC1400Events {
        fn from(value: TransferFilter) -> Self {
            Self::TransferFilter(value)
        }
    }
    impl ::core::convert::From<TransferByPartitionFilter> for ERC1400Events {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC1400Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC1400Calls {
    ...
    impl ::core::fmt::Display for ERC1400Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddMinterCall> for ERC1400Calls {
        fn from(value: AddMinterCall) -> Self {
            Self::AddMinter(value)
        }
    }
    impl ::core::convert::From<AllowanceCall> for ERC1400Calls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<AllowanceByPartitionCall> for ERC1400Calls {
        fn from(value: AllowanceByPartitionCall) -> Self {
            Self::AllowanceByPartition(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for ERC1400Calls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<ApproveByPartitionCall> for ERC1400Calls {
        fn from(value: ApproveByPartitionCall) -> Self {
            Self::ApproveByPartition(value)
        }
    }
    impl ::core::convert::From<AuthorizeOperatorCall> for ERC1400Calls {
        fn from(value: AuthorizeOperatorCall) -> Self {
            Self::AuthorizeOperator(value)
        }
    }
    impl ::core::convert::From<AuthorizeOperatorByPartitionCall> for ERC1400Calls {
        fn from(value: AuthorizeOperatorByPartitionCall) -> Self {
            Self::AuthorizeOperatorByPartition(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for ERC1400Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BalanceOfByPartitionCall> for ERC1400Calls {
        fn from(value: BalanceOfByPartitionCall) -> Self {
            Self::BalanceOfByPartition(value)
        }
    }
    impl ::core::convert::From<CanImplementInterfaceForAddressCall> for ERC1400Calls {
        fn from(value: CanImplementInterfaceForAddressCall) -> Self {
            Self::CanImplementInterfaceForAddress(value)
        }
    }
    impl ::core::convert::From<ControllersCall> for ERC1400Calls {
        fn from(value: ControllersCall) -> Self {
            Self::Controllers(value)
        }
    }
    impl ::core::convert::From<ControllersByPartitionCall> for ERC1400Calls {
        fn from(value: ControllersByPartitionCall) -> Self {
            Self::ControllersByPartition(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for ERC1400Calls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<DomainNameCall> for ERC1400Calls {
        fn from(value: DomainNameCall) -> Self {
            Self::DomainName(value)
        }
    }
    impl ::core::convert::From<DomainSeparatorCall> for ERC1400Calls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<DomainVersionCall> for ERC1400Calls {
        fn from(value: DomainVersionCall) -> Self {
            Self::DomainVersion(value)
        }
    }
    impl ::core::convert::From<GenerateDomainSeparatorCall> for ERC1400Calls {
        fn from(value: GenerateDomainSeparatorCall) -> Self {
            Self::GenerateDomainSeparator(value)
        }
    }
    impl ::core::convert::From<GetAllDocumentsCall> for ERC1400Calls {
        fn from(value: GetAllDocumentsCall) -> Self {
            Self::GetAllDocuments(value)
        }
    }
    impl ::core::convert::From<GetDefaultPartitionsCall> for ERC1400Calls {
        fn from(value: GetDefaultPartitionsCall) -> Self {
            Self::GetDefaultPartitions(value)
        }
    }
    impl ::core::convert::From<GetDocumentCall> for ERC1400Calls {
        fn from(value: GetDocumentCall) -> Self {
            Self::GetDocument(value)
        }
    }
    impl ::core::convert::From<GranularityCall> for ERC1400Calls {
        fn from(value: GranularityCall) -> Self {
            Self::Granularity(value)
        }
    }
    impl ::core::convert::From<IsControllableCall> for ERC1400Calls {
        fn from(value: IsControllableCall) -> Self {
            Self::IsControllable(value)
        }
    }
    impl ::core::convert::From<IsIssuableCall> for ERC1400Calls {
        fn from(value: IsIssuableCall) -> Self {
            Self::IsIssuable(value)
        }
    }
    impl ::core::convert::From<IsMinterCall> for ERC1400Calls {
        fn from(value: IsMinterCall) -> Self {
            Self::IsMinter(value)
        }
    }
    impl ::core::convert::From<IsOperatorCall> for ERC1400Calls {
        fn from(value: IsOperatorCall) -> Self {
            Self::IsOperator(value)
        }
    }
    impl ::core::convert::From<IsOperatorForPartitionCall> for ERC1400Calls {
        fn from(value: IsOperatorForPartitionCall) -> Self {
            Self::IsOperatorForPartition(value)
        }
    }
    impl ::core::convert::From<IssueCall> for ERC1400Calls {
        fn from(value: IssueCall) -> Self {
            Self::Issue(value)
        }
    }
    impl ::core::convert::From<IssueByPartitionCall> for ERC1400Calls {
        fn from(value: IssueByPartitionCall) -> Self {
            Self::IssueByPartition(value)
        }
    }
    impl ::core::convert::From<MigrateCall> for ERC1400Calls {
        fn from(value: MigrateCall) -> Self {
            Self::Migrate(value)
        }
    }
    impl ::core::convert::From<NameCall> for ERC1400Calls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<OperatorRedeemByPartitionCall> for ERC1400Calls {
        fn from(value: OperatorRedeemByPartitionCall) -> Self {
            Self::OperatorRedeemByPartition(value)
        }
    }
    impl ::core::convert::From<OperatorTransferByPartitionCall> for ERC1400Calls {
        fn from(value: OperatorTransferByPartitionCall) -> Self {
            Self::OperatorTransferByPartition(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for ERC1400Calls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PartitionsOfCall> for ERC1400Calls {
        fn from(value: PartitionsOfCall) -> Self {
            Self::PartitionsOf(value)
        }
    }
    impl ::core::convert::From<RedeemCall> for ERC1400Calls {
        fn from(value: RedeemCall) -> Self {
            Self::Redeem(value)
        }
    }
    impl ::core::convert::From<RedeemByPartitionCall> for ERC1400Calls {
        fn from(value: RedeemByPartitionCall) -> Self {
            Self::RedeemByPartition(value)
        }
    }
    impl ::core::convert::From<RedeemFromCall> for ERC1400Calls {
        fn from(value: RedeemFromCall) -> Self {
            Self::RedeemFrom(value)
        }
    }
    impl ::core::convert::From<RemoveDocumentCall> for ERC1400Calls {
        fn from(value: RemoveDocumentCall) -> Self {
            Self::RemoveDocument(value)
        }
    }
    impl ::core::convert::From<RemoveMinterCall> for ERC1400Calls {
        fn from(value: RemoveMinterCall) -> Self {
            Self::RemoveMinter(value)
        }
    }
    impl ::core::convert::From<RenounceControlCall> for ERC1400Calls {
        fn from(value: RenounceControlCall) -> Self {
            Self::RenounceControl(value)
        }
    }
    impl ::core::convert::From<RenounceIssuanceCall> for ERC1400Calls {
        fn from(value: RenounceIssuanceCall) -> Self {
            Self::RenounceIssuance(value)
        }
    }
    impl ::core::convert::From<RenounceMinterCall> for ERC1400Calls {
        fn from(value: RenounceMinterCall) -> Self {
            Self::RenounceMinter(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for ERC1400Calls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<RevokeOperatorCall> for ERC1400Calls {
        fn from(value: RevokeOperatorCall) -> Self {
            Self::RevokeOperator(value)
        }
    }
    impl ::core::convert::From<RevokeOperatorByPartitionCall> for ERC1400Calls {
        fn from(value: RevokeOperatorByPartitionCall) -> Self {
            Self::RevokeOperatorByPartition(value)
        }
    }
    impl ::core::convert::From<SetControllersCall> for ERC1400Calls {
        fn from(value: SetControllersCall) -> Self {
            Self::SetControllers(value)
        }
    }
    impl ::core::convert::From<SetDefaultPartitionsCall> for ERC1400Calls {
        fn from(value: SetDefaultPartitionsCall) -> Self {
            Self::SetDefaultPartitions(value)
        }
    }
    impl ::core::convert::From<SetDocumentCall> for ERC1400Calls {
        fn from(value: SetDocumentCall) -> Self {
            Self::SetDocument(value)
        }
    }
    impl ::core::convert::From<SetPartitionControllersCall> for ERC1400Calls {
        fn from(value: SetPartitionControllersCall) -> Self {
            Self::SetPartitionControllers(value)
        }
    }
    impl ::core::convert::From<SetTokenExtensionCall> for ERC1400Calls {
        fn from(value: SetTokenExtensionCall) -> Self {
            Self::SetTokenExtension(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for ERC1400Calls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TotalPartitionsCall> for ERC1400Calls {
        fn from(value: TotalPartitionsCall) -> Self {
            Self::TotalPartitions(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for ERC1400Calls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TotalSupplyByPartitionCall> for ERC1400Calls {
        fn from(value: TotalSupplyByPartitionCall) -> Self {
            Self::TotalSupplyByPartition(value)
        }
    }
    impl ::core::convert::From<TransferCall> for ERC1400Calls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferByPartitionCall> for ERC1400Calls {
        fn from(value: TransferByPartitionCall) -> Self {
            Self::TransferByPartition(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for ERC1400Calls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<TransferFromWithDataCall> for ERC1400Calls {
        fn from(value: TransferFromWithDataCall) -> Self {
            Self::TransferFromWithData(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for ERC1400Calls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<TransferWithDataCall> for ERC1400Calls {
