...
pub mod fake_erc1400_mock {
    ...
    pub static FAKEERC1400MOCK_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static FAKEERC1400MOCK_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct FakeERC1400Mock<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for FakeERC1400Mock<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for FakeERC1400Mock<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for FakeERC1400Mock<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for FakeERC1400Mock<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(FakeERC1400Mock)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> FakeERC1400Mock<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                FAKEERC1400MOCK_ABI.clone(),
                FAKEERC1400MOCK_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn transfer_from_with_data(
            ...
            self.0
                .method_hash([238, 83, 47, 49], (from, to, value, p3))
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            FakeERC1400MockEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for FakeERC1400Mock<M> {
    ...
    pub enum FakeERC1400MockEvents {
    ...
    impl ::ethers::contract::EthLogDecode for FakeERC1400MockEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = ApprovalByPartitionFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::ApprovalByPartitionFilter(decoded));
            }
            if let Ok(decoded) = AuthorizedOperatorFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::AuthorizedOperatorFilter(decoded));
            }
            if let Ok(decoded) = AuthorizedOperatorByPartitionFilter::decode_log(log) {
                return Ok(
                    FakeERC1400MockEvents::AuthorizedOperatorByPartitionFilter(decoded),
                );
            }
            if let Ok(decoded) = ChangedPartitionFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::ChangedPartitionFilter(decoded));
            }
            if let Ok(decoded) = DocumentRemovedFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::DocumentRemovedFilter(decoded));
            }
            if let Ok(decoded) = DocumentUpdatedFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::DocumentUpdatedFilter(decoded));
            }
            if let Ok(decoded) = IssuedFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::IssuedFilter(decoded));
            }
            if let Ok(decoded) = IssuedByPartitionFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::IssuedByPartitionFilter(decoded));
            }
            if let Ok(decoded) = MinterAddedFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::MinterAddedFilter(decoded));
            }
            if let Ok(decoded) = MinterRemovedFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::MinterRemovedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = RedeemedFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::RedeemedFilter(decoded));
            }
            if let Ok(decoded) = RedeemedByPartitionFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::RedeemedByPartitionFilter(decoded));
            }
            if let Ok(decoded) = RevokedOperatorFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::RevokedOperatorFilter(decoded));
            }
            if let Ok(decoded) = RevokedOperatorByPartitionFilter::decode_log(log) {
                return Ok(
                    FakeERC1400MockEvents::RevokedOperatorByPartitionFilter(decoded),
                );
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::TransferFilter(decoded));
            }
            if let Ok(decoded) = TransferByPartitionFilter::decode_log(log) {
                return Ok(FakeERC1400MockEvents::TransferByPartitionFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for FakeERC1400MockEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for FakeERC1400MockEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalByPartitionFilter> for FakeERC1400MockEvents {
        fn from(value: ApprovalByPartitionFilter) -> Self {
            Self::ApprovalByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<AuthorizedOperatorFilter> for FakeERC1400MockEvents {
    ...
    for FakeERC1400MockEvents {
        fn from(value: AuthorizedOperatorByPartitionFilter) -> Self {
            Self::AuthorizedOperatorByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<ChangedPartitionFilter> for FakeERC1400MockEvents {
        fn from(value: ChangedPartitionFilter) -> Self {
            Self::ChangedPartitionFilter(value)
        }
    }
    impl ::core::convert::From<DocumentRemovedFilter> for FakeERC1400MockEvents {
        fn from(value: DocumentRemovedFilter) -> Self {
            Self::DocumentRemovedFilter(value)
        }
    }
    impl ::core::convert::From<DocumentUpdatedFilter> for FakeERC1400MockEvents {
        fn from(value: DocumentUpdatedFilter) -> Self {
            Self::DocumentUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<IssuedFilter> for FakeERC1400MockEvents {
        fn from(value: IssuedFilter) -> Self {
            Self::IssuedFilter(value)
        }
    }
    impl ::core::convert::From<IssuedByPartitionFilter> for FakeERC1400MockEvents {
        fn from(value: IssuedByPartitionFilter) -> Self {
            Self::IssuedByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<MinterAddedFilter> for FakeERC1400MockEvents {
        fn from(value: MinterAddedFilter) -> Self {
            Self::MinterAddedFilter(value)
        }
    }
    impl ::core::convert::From<MinterRemovedFilter> for FakeERC1400MockEvents {
        fn from(value: MinterRemovedFilter) -> Self {
            Self::MinterRemovedFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for FakeERC1400MockEvents {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<RedeemedFilter> for FakeERC1400MockEvents {
        fn from(value: RedeemedFilter) -> Self {
            Self::RedeemedFilter(value)
        }
    }
    impl ::core::convert::From<RedeemedByPartitionFilter> for FakeERC1400MockEvents {
        fn from(value: RedeemedByPartitionFilter) -> Self {
            Self::RedeemedByPartitionFilter(value)
        }
    }
    impl ::core::convert::From<RevokedOperatorFilter> for FakeERC1400MockEvents {
    ...
    impl ::core::convert::From<TransferFilter> for FakeERC1400MockEvents {
        fn from(value: TransferFilter) -> Self {
            Self::TransferFilter(value)
        }
    }
    impl ::core::convert::From<TransferByPartitionFilter> for FakeERC1400MockEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for FakeERC1400MockCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for FakeERC1400MockCalls {
    ...
    impl ::core::fmt::Display for FakeERC1400MockCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddMinterCall> for FakeERC1400MockCalls {
        fn from(value: AddMinterCall) -> Self {
            Self::AddMinter(value)
        }
    }
    impl ::core::convert::From<AllowanceCall> for FakeERC1400MockCalls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<AllowanceByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: AllowanceByPartitionCall) -> Self {
            Self::AllowanceByPartition(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for FakeERC1400MockCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<ApproveByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: ApproveByPartitionCall) -> Self {
            Self::ApproveByPartition(value)
        }
    }
    impl ::core::convert::From<AuthorizeOperatorCall> for FakeERC1400MockCalls {
    ...
    for FakeERC1400MockCalls {
        fn from(value: AuthorizeOperatorByPartitionCall) -> Self {
            Self::AuthorizeOperatorByPartition(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for FakeERC1400MockCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BalanceOfByPartitionCall> for FakeERC1400MockCalls {
    ...
    impl ::core::convert::From<ControllersCall> for FakeERC1400MockCalls {
        fn from(value: ControllersCall) -> Self {
            Self::Controllers(value)
        }
    }
    impl ::core::convert::From<ControllersByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: ControllersByPartitionCall) -> Self {
            Self::ControllersByPartition(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for FakeERC1400MockCalls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<DomainNameCall> for FakeERC1400MockCalls {
        fn from(value: DomainNameCall) -> Self {
            Self::DomainName(value)
        }
    }
    impl ::core::convert::From<DomainSeparatorCall> for FakeERC1400MockCalls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<DomainVersionCall> for FakeERC1400MockCalls {
        fn from(value: DomainVersionCall) -> Self {
            Self::DomainVersion(value)
        }
    }
    impl ::core::convert::From<GenerateDomainSeparatorCall> for FakeERC1400MockCalls {
        fn from(value: GenerateDomainSeparatorCall) -> Self {
            Self::GenerateDomainSeparator(value)
        }
    }
    impl ::core::convert::From<GetAllDocumentsCall> for FakeERC1400MockCalls {
        fn from(value: GetAllDocumentsCall) -> Self {
            Self::GetAllDocuments(value)
        }
    }
    impl ::core::convert::From<GetDefaultPartitionsCall> for FakeERC1400MockCalls {
        fn from(value: GetDefaultPartitionsCall) -> Self {
            Self::GetDefaultPartitions(value)
        }
    }
    impl ::core::convert::From<GetDocumentCall> for FakeERC1400MockCalls {
        fn from(value: GetDocumentCall) -> Self {
            Self::GetDocument(value)
        }
    }
    impl ::core::convert::From<GranularityCall> for FakeERC1400MockCalls {
        fn from(value: GranularityCall) -> Self {
            Self::Granularity(value)
        }
    }
    impl ::core::convert::From<IsControllableCall> for FakeERC1400MockCalls {
        fn from(value: IsControllableCall) -> Self {
            Self::IsControllable(value)
        }
    }
    impl ::core::convert::From<IsIssuableCall> for FakeERC1400MockCalls {
        fn from(value: IsIssuableCall) -> Self {
            Self::IsIssuable(value)
        }
    }
    impl ::core::convert::From<IsMinterCall> for FakeERC1400MockCalls {
        fn from(value: IsMinterCall) -> Self {
            Self::IsMinter(value)
        }
    }
    impl ::core::convert::From<IsOperatorCall> for FakeERC1400MockCalls {
        fn from(value: IsOperatorCall) -> Self {
            Self::IsOperator(value)
        }
    }
    impl ::core::convert::From<IsOperatorForPartitionCall> for FakeERC1400MockCalls {
        fn from(value: IsOperatorForPartitionCall) -> Self {
            Self::IsOperatorForPartition(value)
        }
    }
    impl ::core::convert::From<IssueCall> for FakeERC1400MockCalls {
        fn from(value: IssueCall) -> Self {
            Self::Issue(value)
        }
    }
    impl ::core::convert::From<IssueByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: IssueByPartitionCall) -> Self {
            Self::IssueByPartition(value)
        }
    }
    impl ::core::convert::From<MigrateCall> for FakeERC1400MockCalls {
        fn from(value: MigrateCall) -> Self {
            Self::Migrate(value)
        }
    }
    impl ::core::convert::From<NameCall> for FakeERC1400MockCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<OperatorRedeemByPartitionCall> for FakeERC1400MockCalls {
    ...
    impl ::core::convert::From<OwnerCall> for FakeERC1400MockCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PartitionsOfCall> for FakeERC1400MockCalls {
        fn from(value: PartitionsOfCall) -> Self {
            Self::PartitionsOf(value)
        }
    }
    impl ::core::convert::From<RedeemCall> for FakeERC1400MockCalls {
        fn from(value: RedeemCall) -> Self {
            Self::Redeem(value)
        }
    }
    impl ::core::convert::From<RedeemByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: RedeemByPartitionCall) -> Self {
            Self::RedeemByPartition(value)
        }
    }
    impl ::core::convert::From<RedeemFromCall> for FakeERC1400MockCalls {
        fn from(value: RedeemFromCall) -> Self {
            Self::RedeemFrom(value)
        }
    }
    impl ::core::convert::From<RemoveDocumentCall> for FakeERC1400MockCalls {
        fn from(value: RemoveDocumentCall) -> Self {
            Self::RemoveDocument(value)
        }
    }
    impl ::core::convert::From<RemoveMinterCall> for FakeERC1400MockCalls {
        fn from(value: RemoveMinterCall) -> Self {
            Self::RemoveMinter(value)
        }
    }
    impl ::core::convert::From<RenounceControlCall> for FakeERC1400MockCalls {
        fn from(value: RenounceControlCall) -> Self {
            Self::RenounceControl(value)
        }
    }
    impl ::core::convert::From<RenounceIssuanceCall> for FakeERC1400MockCalls {
        fn from(value: RenounceIssuanceCall) -> Self {
            Self::RenounceIssuance(value)
        }
    }
    impl ::core::convert::From<RenounceMinterCall> for FakeERC1400MockCalls {
        fn from(value: RenounceMinterCall) -> Self {
            Self::RenounceMinter(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for FakeERC1400MockCalls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<RevokeOperatorCall> for FakeERC1400MockCalls {
        fn from(value: RevokeOperatorCall) -> Self {
            Self::RevokeOperator(value)
        }
    }
    impl ::core::convert::From<RevokeOperatorByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: RevokeOperatorByPartitionCall) -> Self {
            Self::RevokeOperatorByPartition(value)
        }
    }
    impl ::core::convert::From<SetControllersCall> for FakeERC1400MockCalls {
        fn from(value: SetControllersCall) -> Self {
            Self::SetControllers(value)
        }
    }
    impl ::core::convert::From<SetDefaultPartitionsCall> for FakeERC1400MockCalls {
        fn from(value: SetDefaultPartitionsCall) -> Self {
            Self::SetDefaultPartitions(value)
        }
    }
    impl ::core::convert::From<SetDocumentCall> for FakeERC1400MockCalls {
        fn from(value: SetDocumentCall) -> Self {
            Self::SetDocument(value)
        }
    }
    impl ::core::convert::From<SetPartitionControllersCall> for FakeERC1400MockCalls {
        fn from(value: SetPartitionControllersCall) -> Self {
            Self::SetPartitionControllers(value)
        }
    }
    impl ::core::convert::From<SetTokenExtensionCall> for FakeERC1400MockCalls {
        fn from(value: SetTokenExtensionCall) -> Self {
            Self::SetTokenExtension(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for FakeERC1400MockCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TotalPartitionsCall> for FakeERC1400MockCalls {
        fn from(value: TotalPartitionsCall) -> Self {
            Self::TotalPartitions(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for FakeERC1400MockCalls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TotalSupplyByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: TotalSupplyByPartitionCall) -> Self {
            Self::TotalSupplyByPartition(value)
        }
    }
    impl ::core::convert::From<TransferCall> for FakeERC1400MockCalls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferByPartitionCall> for FakeERC1400MockCalls {
        fn from(value: TransferByPartitionCall) -> Self {
            Self::TransferByPartition(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for FakeERC1400MockCalls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<TransferFromWithDataCall> for FakeERC1400MockCalls {
        fn from(value: TransferFromWithDataCall) -> Self {
            Self::TransferFromWithData(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for FakeERC1400MockCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<TransferWithDataCall> for FakeERC1400MockCalls {
